...
class GetUserActivationStatusResetPassword {
	...
	@Keyword
	getGetUserActivationStatusResetPasswordStoreDB(Connection conn, String tenantCode) {
		stm = conn.createStatement()

		resultSet = stm.executeQuery("select msl.code, mst.tenant_code from ms_tenant mst left join ms_lov msl on mst.lov_default_otp_sending_options = msl.id_lov where tenant_code = '" + tenantCode + "'")
		metadata = resultSet.metaData
