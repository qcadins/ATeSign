...
ArrayList resultStatusAktivasi = CustomKeywords.'connection.ErrorReport.getStatusActivation'(conneSign)
...
modifyObjectButtonView = WebUI.modifyObjectProperty(findTestObject('ErrorReport/button_View'), 'xpath', 'equals', ('/html/body/app-root/app-full-layout/div/div[2]/div/div[2]/app-error-report/app-msx-paging/app-msx-datatable/section/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[' + 
    variable.size()) + ']/datatable-body-row/div[2]/datatable-body-cell[10]/div/a[1]/em', true)
...
modifyObjectLabelNamaKonsumen = WebUI.modifyObjectProperty(findTestObject('ErrorReport/label_NamaKonsumen'), 'xpath', 'equals', 
    ('/html/body/app-root/app-full-layout/div/div[2]/div/div[2]/app-error-report/app-msx-paging/app-msx-datatable/section/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[' + 
    variable.size()) + ']/datatable-body-row/div[2]/datatable-body-cell[3]/div/p', true)
...
checkVerifyEqualOrMatch(WebUI.verifyMatch(WebUI.getText(findTestObject('ErrorReport/label_SignerType')), 'Customer', false, 
        FailureHandling.CONTINUE_ON_FAILURE), ' Signer Type')

'verify data UI dan DB'
checkVerifyEqualOrMatch(WebUI.verifyMatch(WebUI.getText(findTestObject('ErrorReport/label_SignerName')), resultStatusAktivasi[
        index++], false, FailureHandling.CONTINUE_ON_FAILURE), ' Signer Name')

'verify total data UI dan DB'
checkVerifyEqualOrMatch(WebUI.verifyMatch(WebUI.getText(findTestObject('ErrorReport/label_SignerNIK')), resultStatusAktivasi[
        index++], false, FailureHandling.CONTINUE_ON_FAILURE), ' Signer NIK')
...
'verify total data UI dan DB'
checkVerifyEqualOrMatch(WebUI.verifyMatch(WebUI.getText(findTestObject('ErrorReport/label_StatusAktivasi')), status, false, 
        FailureHandling.CONTINUE_ON_FAILURE), ' Status Aktivasi')
