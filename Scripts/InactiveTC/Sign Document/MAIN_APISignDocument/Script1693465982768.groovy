    ...
    if (WS.verifyResponseStatusCode(respon_login, 200, FailureHandling.OPTIONAL) == true) {
        ...
        if (WS.verifyResponseStatusCode(respon_signdoc, 200, FailureHandling.OPTIONAL) == true) {
            ...
            if (status_Code == 0) {
                ...
                WebUI.callTestCase(findTestCase('InactiveTC/Sign Document/SignDocumentStoreDb'), [('API_Excel_Path') : 'Registrasi/SignDocument'], 
        ...
        WebUI.callTestCase(findTestCase('InactiveTC/Login_Inveditor'), [:], FailureHandling.STOP_ON_FAILURE)

        'call test case error report'
        WebUI.callTestCase(findTestCase('InactiveTC/Sign Document/ErrorReport'), [('excelPathSignDoc') : 'Registrasi/BulkSignDocument'], 
