...
'input kata sandi'
WebUI.setText(findTestObject('Object Repository/BuatUndangan/FormAktivasi/input_KataSandi'), findTestData(excelPathBuatUndangan).getValue(
...
WebUI.setText(findTestObject('Object Repository/BuatUndangan/FormAktivasi/input_UlangKataSandi'), findTestData(excelPathBuatUndangan).getValue(
