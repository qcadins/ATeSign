/html/body/ngb-modal-window/div/div/app-error-report-detail/div/buttonimport static com.kms.katalon.core.checkpoint.CheckpointFactory.findCheckpoint
...
String resultErrorDetail = CustomKeywords.'connection.dataVerif.getErrorReportDetail'(conneSign, findTestData(excelPathBuatUndangan).getValue(GlobalVariable.NumofColm, 
        10).toUpperCase())
