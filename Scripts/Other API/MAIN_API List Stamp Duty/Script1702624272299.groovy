...
for (GlobalVariable.NumofColm = 2; GlobalVariable.NumofColm <= countColmExcel; (GlobalVariable.NumofColm)++) {
	if (findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('Status')).length() == 0) {
		...
		respon = WS.sendRequest(findTestObject('Postman/List Stamp Duty', [('tenantCode') : findTestData(excelPath).getValue(
						...
						, ('invoiceNo') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('invoiceNo'))
						, ('stampDutyStatus') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('stampDutyStatus'))
						, ('businessLineCode') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('businessLineCode'))
						...
						, ('stampDutyUsedDtStart') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('stampDutyUsedDtStart'))
						, ('stampDutyUsedDtEnd') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('stampDutyUsedDtEnd'))
						, ('stampDutyNo') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('stampDutyNo'))
