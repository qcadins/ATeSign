            ...
            if (WS.verifyResponseStatusCode(respon, 200, FailureHandling.OPTIONAL) == true) {
                ...
                if (status_Code == 0) {
                    ...
                    if (GlobalVariable.checkStoreDB == 'Yes' && totalResult != 0 && totalResult != '') {
                        ...
                        'get data store db'
                        int result = CustomKeywords.'connection.APIFullService.listTenantAPIOnly'(conneSign,
							findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('Tenant Name*')),
							findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('Status*')))
