...
for (GlobalVariable.NumofColm = 2; GlobalVariable.NumofColm <= countColmExcel; (GlobalVariable.NumofColm)++) {
    if (findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('Status')).length() == 0) {
        ...
        respon = WS.sendRequest(findTestObject('Postman/Error History Act Status', [('tenantCode') : findTestData(excelPath).getValue(
                        GlobalVariable.NumofColm, rowExcel('tenantCode')), ('idErrorHistory') : findTestData(excelPath).getValue(
                        GlobalVariable.NumofColm, rowExcel('idErrorHistory')), ('callerId') : findTestData(excelPath).getValue(
