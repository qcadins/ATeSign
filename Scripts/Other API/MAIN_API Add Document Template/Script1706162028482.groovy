...
for (GlobalVariable.NumofColm = 2; GlobalVariable.NumofColm <= countColmExcel; (GlobalVariable.NumofColm)++) {
    if (findTestData(excelPath).getValue(GlobalVariable.NumofColm, rowExcel('Status')).length() == 0) {
        ...
        respon = WS.sendRequest(findTestObject('Postman/Add Document Template', [('callerId') : findTestData(excelPath).getValue(
                        GlobalVariable.NumofColm, rowExcel('callerId')), ('documentExample') : CustomKeywords.'customizekeyword.ConvertFile.base64File'(findTestData(excelPath).getValue(
                        GlobalVariable.NumofColm, rowExcel('documentExample'))), ('documentTemplateCode') : findTestData(excelPath).getValue(
                        GlobalVariable.NumofColm, rowExcel('documentTemplateCode')), ('documentTemplateName') : findTestData(excelPath).getValue(
                        GlobalVariable.NumofColm, rowExcel('documentTemplateName')), ('documentTemplateDescription') : findTestData(excelPath).getValue(
                        GlobalVariable.NumofColm, rowExcel('documentTemplateDescription')), ('isActive') : findTestData(excelPath).getValue(
                        GlobalVariable.NumofColm, rowExcel('isActive')), ('isSequence') : findTestData(excelPath).getValue(
                        GlobalVariable.NumofColm, rowExcel('isSequence')), ('numberOfPage') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, 
                        rowExcel('numberOfPage')), ('paymentSignTypeCode') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, 
                        rowExcel('paymentSignTypeCode')), ('useSignQr') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, 
                        rowExcel('useSignQr')), ('tenantCode') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, 
                        rowExcel('tenantCode')), ('vendorCode') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, 
                        rowExcel('vendorCode')), ('isSignLocOnly') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, 
                        rowExcel('isSignLocOnly')), ('signer') : findTestData(excelPath).getValue(GlobalVariable.NumofColm, 
                        rowExcel('signer'))]))
