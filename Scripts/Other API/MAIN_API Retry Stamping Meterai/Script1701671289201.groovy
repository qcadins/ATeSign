iimport static com.kms.katalon.core.testcase.TestCaseFactory.findTestCase
                ...
                for (i = 1; i <= 12; i++) {
                    ...
                    if ((prosesMaterai == 51) || (prosesMaterai == 61)) {
                        ...
                        if (i == 12) {
                            ...
                            CustomKeywords.'customizekeyword.WriteExcel.writeToExcelStatusReason'(sheet, GlobalVariable.NumofColm, 
                                GlobalVariable.StatusFailed, ((((findTestData(excelPath).getValue(GlobalVariable.NumofColm, 
                                    rowExcel('Reason Failed')).replace('-','') + ';') + GlobalVariable.ReasonFailedProsesStamping) + ' dengan jeda waktu ') + 
                                (i * 12)) + ' detik ')
