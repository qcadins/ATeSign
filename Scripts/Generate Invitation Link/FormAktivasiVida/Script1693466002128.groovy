...
'input kata sandi'
WebUI.setText(findTestObject('RegisterEsign/FormAktivasiEsign/input_KataSandi'), findTestData(excelPathGenerateLink).getValue(
...
WebUI.setText(findTestObject('RegisterEsign/FormAktivasiEsign/input_UlangKataSandi'), findTestData(excelPathGenerateLink).getValue(
...
def inputOTP(int inputed, int delayExpiredOTP, Connection conneSign) {
	...
	if (WebUI.verifyElementPresent(findTestObject('RegisterEsign/FormAktivasiEsign/label_PopupMsg'), GlobalVariable.TimeOut,
		...
		if (findTestData(excelPathGenerateLink).getValue(GlobalVariable.NumofColm, rowExcel('Input Correct OTP - Aktivasi')).equalsIgnoreCase('Yes')) {
			...
			'input OTP'
			WebUI.setText(findTestObject('RegisterEsign/FormAktivasiEsign/input_OTP'), findTestData(excelPathGenerateLink).getValue(
