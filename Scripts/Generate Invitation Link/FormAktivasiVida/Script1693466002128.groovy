...
'input kata sandi'
WebUI.setText(findTestObject('BuatUndangan/FormAktivasiEsign/input_KataSandi'), findTestData(excelPathGenerateLink).getValue(
...
WebUI.setText(findTestObject('BuatUndangan/FormAktivasiEsign/input_UlangKataSandi'), findTestData(excelPathGenerateLink).getValue(
...
def inputOTP(int inputed, int delayExpiredOTP, Connection conneSign) {
	...
	if (WebUI.verifyElementPresent(findTestObject('BuatUndangan/FormAktivasiEsign/label_PopupMsg'), GlobalVariable.TimeOut,
		...
		if (findTestData(excelPathGenerateLink).getValue(GlobalVariable.NumofColm, rowExcel('Input Correct OTP - Aktivasi')).equalsIgnoreCase('Yes')) {
			...
			'input OTP'
			WebUI.setText(findTestObject('BuatUndangan/FormAktivasiEsign/input_OTP'), findTestData(excelPathGenerateLink).getValue(
