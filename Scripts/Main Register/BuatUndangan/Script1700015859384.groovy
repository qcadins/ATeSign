...
int isMandatoryComplete = Integer.parseInt(findTestData(excelPathRegister).getValue(GlobalVariable.NumofColm, rowExcel(
...
def inputBuatUndangan() {
    ...
    if (findTestData(excelPathRegister).getValue(GlobalVariable.NumofColm, rowExcel('Jenis Kelamin')).equalsIgnoreCase(
        'M')) {
        'click radio pria'
