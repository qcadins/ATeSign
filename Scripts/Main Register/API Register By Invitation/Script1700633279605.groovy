...
if (findTestData(excelPathRegister).getValue(GlobalVariable.NumofColm, rowExcel('Input correct Message')).equalsIgnoreCase(
    'Yes')) {
...
} else if (findTestData(excelPathRegister).getValue(GlobalVariable.NumofColm, rowExcel('Input correct Message')).equalsIgnoreCase(
    'No')) {
...
sDate) + '" ,"idKtp" : "') + findTestData(excelPathRegister).getValue(GlobalVariable.NumofColm, rowExcel('$NIK'))) + '" , "provinsi" : "') + 
findTestData(excelPathRegister).getValue(GlobalVariable.NumofColm, rowExcel('Provinsi'))) + '" , "kota" : "') + findTestData(
    excelPathRegister).getValue(GlobalVariable.NumofColm, rowExcel('Kota'))) + '" , "kecamatan" : "') + findTestData(excelPathRegister).getValue(
    GlobalVariable.NumofColm, rowExcel('Kecamatan'))) + '" ,"kelurahan": "') + findTestData(excelPathRegister).getValue(
    GlobalVariable.NumofColm, rowExcel('Kelurahan'))) + '" ,"kodePos" : "') + findTestData(excelPathRegister).getValue(GlobalVariable.NumofColm, 
    rowExcel('Kode Pos'))) + '" ,"alamat" : "') + findTestData(excelPathRegister).getValue(GlobalVariable.NumofColm, rowExcel(
        'Alamat'))) + '" ,"selfPhoto" : "') + selfPhoto) + '" ,"idPhoto" : "') + idPhoto) + '" }')
