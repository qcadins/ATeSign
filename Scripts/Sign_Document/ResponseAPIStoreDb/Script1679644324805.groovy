...
'looping berdasarkan total document yang ada'
	...
	ArrayList<String> result = CustomKeywords.'connection.dataVerif.getbulkSign'(conneSign, findTestData(API_Excel_Path).getValue(GlobalVariable.NumofColm, 12), findTestData(API_Excel_Path).getValue(GlobalVariable.NumofColm, 11))
