    ...
    if (WS.verifyResponseStatusCode(respon_login, 200, FailureHandling.OPTIONAL) == true) {
        ...
        if (WS.verifyResponseStatusCode(respon_signdoc, 200, FailureHandling.OPTIONAL) == true) {
            ...
            if (status_Code == 0) {
                ...
                WebUI.callTestCase(findTestCase('Sign Document/SignDocumentStoreDb'), [('API_Excel_Path') : 'Registrasi/SignDocument'], 
        ...
        WebUI.callTestCase(findTestCase('Sign Document/ErrorReport'), [('excelPathSignDoc') : 'Registrasi/BulkSignDocument'], 
