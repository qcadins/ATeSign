...
for (GlobalVariable.NumofColm = 2; GlobalVariable.NumofColm <= countColmExcel; (GlobalVariable.NumofColm)++) {
	...
	if (findTestData(excelPathPencarianDokumen).getValue(GlobalVariable.NumofColm, 1).length() == 0) {
		...
		WebUI.setText(findTestObject('PencarianDokumen/input_NamaPelanggan'), findTestData(excelPathPencarianDokumen).getValue(GlobalVariable.NumofColm, 
				9))
		
		'input no kontrak'
		WebUI.setText(findTestObject('PencarianDokumen/input_NomorKontrak'), findTestData(excelPathPencarianDokumen).getValue(GlobalVariable.NumofColm, 
				10))
		...
		'input tipeDokumen'
		WebUI.setText(findTestObject('PencarianDokumen/select_TipeDokumen'), findTestData(excelPathPencarianDokumen).getValue(GlobalVariable.NumofColm, 
				15))
		...
		'input status'
		WebUI.setText(findTestObject('PencarianDokumen/select_Status'), findTestData(excelPathPencarianDokumen).getValue(GlobalVariable.NumofColm, 
				16))
		...
		if (findTestData(excelPathPencarianDokumen).getValue(GlobalVariable.NumofColm, 7) == 'View Dokumen') {
			...
			'verify no kontrak'
			checkVerifyEqualOrMatch(WebUI.verifyMatch(WebUI.getText(findTestObject('PencarianDokumen/label_noKontrak')).replace('No Kontrak ','')
					, findTestData(excelPathPencarianDokumen).getValue(GlobalVariable.NumofColm, 10), false, 
			...
			'get data signer'
			ArrayList<String> resultDataSigner = CustomKeywords.'connection.dataVerif.getSignerInfo'(conneSign, findTestData(excelPathPencarianDokumen).getValue(
					GlobalVariable.NumofColm, 10), GlobalVariable.Psre)
			
			'get row'
			variable = DriverFactory.getWebDriver().findElements(By.cssSelector('body > ngb-modal-window > div > div > app-signer > div.modal-body > app-msx-datatable > section > ngx-datatable > div > datatable-body > datatable-selection > datatable-scroller datatable-row-wrapper'))
			...
			for (index = 1; index <= variable.size(); index++) {
				...
				modifyObjectLabelTipe = WebUI.modifyObjectProperty(findTestObject('PencarianDokumen/modifyObject'), 'xpath', 'equals', 
						...
						modifyObjectLabelNama = WebUI.modifyObjectProperty(findTestObject('PencarianDokumen/modifyObject'), 'xpath', 'equals', 
								('/html/body/ngb-modal-window/div/div/app-signer/div[2]/app-msx-datatable/section/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[' + 
										index) + ']/datatable-body-row/div[2]/datatable-body-cell[2]/div/p', true)
						
						'modify object label Email'
						modifyObjectLabelEmail = WebUI.modifyObjectProperty(findTestObject('PencarianDokumen/modifyObject'), 'xpath', 'equals', 
								('/html/body/ngb-modal-window/div/div/app-signer/div[2]/app-msx-datatable/section/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[' + 
										index) + ']/datatable-body-row/div[2]/datatable-body-cell[3]/div/p', true)
						
						'modify object label register status'
						modifyObjectLabelRegisterStatus = WebUI.modifyObjectProperty(findTestObject('PencarianDokumen/modifyObject'), 'xpath', 
						...
						modifyObjectLabelSignStatus = WebUI.modifyObjectProperty(findTestObject('PencarianDokumen/modifyObject'), 'xpath', 
								'equals', ('/html/body/ngb-modal-window/div/div/app-signer/div[2]/app-msx-datatable/section/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[' + 
										index) + ']/datatable-body-row/div[2]/datatable-body-cell[5]/div/p', true)
						
						'modify object label sign Date'
						modifyObjectLabelSignDate = WebUI.modifyObjectProperty(findTestObject('PencarianDokumen/modifyObject'), 'xpath', 
								'equals', ('/html/body/ngb-modal-window/div/div/app-signer/div[2]/app-msx-datatable/section/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[' + 
						...
						checkVerifyEqualOrMatch(WebUI.verifyMatch(WebUI.getText(modifyObjectLabelRegisterStatus), resultDataSigner[arrayIndexDB++], 
								false, FailureHandling.CONTINUE_ON_FAILURE))
		...
		int isMandatoryComplete = Integer.parseInt(findTestData(excelPathPencarianDokumen).getValue(GlobalVariable.NumofColm, 4))
...
def checkPaging(Connection conneSign) {
	...
	'get data signer'
	int resultTotalData = CustomKeywords.'connection.dataVerif.getTotalPencarianDokumen'(conneSign, GlobalVariable.userLogin, GlobalVariable.Tenant)
	...
	'get total page'
	def variable = DriverFactory.getWebDriver().findElements(By.cssSelector('body > app-root > app-full-layout > div > div.main-panel > div > div.content-wrapper > app-inquiry > app-msx-paging > app-msx-datatable > section > ngx-datatable > div > datatable-footer > div > datatable-pager > ul li'))

	'modify object last Page'
	def modifyObjectLastPage = WebUI.modifyObjectProperty(findTestObject('PencarianDokumen/modifyObject'), 'xpath',
			'equals', '/html/body/app-root/app-full-layout/div/div[2]/div/div[2]/app-inquiry/app-msx-paging/app-msx-datatable/section/ngx-datatable/div/datatable-footer/div/datatable-pager/ul/li[' +
