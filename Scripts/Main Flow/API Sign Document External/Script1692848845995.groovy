        ...
        if (code == 0) {
            ...
            for (int v = 1; v <= 20; v++) {
                ...
                if ((totalSignedAfter[0]) == ((totalSignedBefore[0]) + Integer.parseInt(signCount))) {
                    ...
                    WebUI.callTestCase(findTestCase('Main Flow/VerifyDocumentMonitoring'), [('excelPathFESignDocument') : excelPathAPISignDocument, ('sheet') : sheet, ('nomorKontrak') : refNumber
