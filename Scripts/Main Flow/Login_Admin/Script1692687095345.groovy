...
WebUI.navigateToUrl(findTestData(excel).getValue(GlobalVariable.NumofColm, 8))

'maximized window'
WebUI.maximizeWindow()

'input email'
WebUI.setText(findTestObject('Login/input_Email'), findTestData(excel).getValue(GlobalVariable.NumofColm, 9))

'store GV user login'
GlobalVariable.userLogin = findTestData(excel).getValue(GlobalVariable.NumofColm, 9)

'input password'
WebUI.setText(findTestObject('Login/input_Password'), findTestData(excel).getValue(GlobalVariable.NumofColm, 10))

'click button login'
WebUI.click(findTestObject('Login/button_Login'), FailureHandling.STOP_ON_FAILURE)

'input perusahaan'
WebUI.setText(findTestObject('Login/input_Perusahaan'), findTestData(excel).getValue(GlobalVariable.NumofColm, 11))

'enter untuk input perusahaan'
WebUI.sendKeys(findTestObject('Login/input_Perusahaan'), Keys.chord(Keys.ENTER))

'input peran'
WebUI.setText(findTestObject('Login/input_Peran'), findTestData(excel).getValue(GlobalVariable.NumofColm, 12))
