    ...
    findTestData(excelPathManualSign).getValue(GlobalVariable.NumofColm, 1).equalsIgnoreCase('Warning')) {
        ...
        if (WebUI.verifyElementPresent(findTestObject('ManualSign/lbl_ManualSign'), GlobalVariable.TimeOut)) {
            ...
            if (emailPenandaTangan != '') {
                ...
                for (int i = 1; i <= emailPenandaTangan.size(); i++) {
                    arrayIndex = 0
                    ...
                    modifyObjectInformasiPenandaTangan = WebUI.modifyObjectProperty(findTestObject('ManualSign/modifyObject'), 
                        'xpath', 'equals', ((('//*[@id="msxForm"]/div[' + index) + ']/div[3]/table/tr[') + i) + ']/td/p', 
                        true)
                    ...
                    checkVerifyEqualOrMatch(WebUI.verifyMatch(CustomKeywords.'customizekeyword.ParseText.convertToSHA256'(
                        ...
                        ' pada informasi nama penanda tangan ')

                    checkVerifyEqualOrMatch(WebUI.verifyMatch(valueInformasi[arrayIndexValue++], emailPenandaTangan[(indexEmail - 
                            1)], false, FailureHandling.CONTINUE_ON_FAILURE), ' pada informasi nama penanda tangan ')
            ...
            if (WebUI.verifyElementNotHasAttribute(findTestObject('ManualSign/button_Save'), 'disabled', GlobalVariable.TimeOut, 
